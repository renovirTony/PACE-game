...
export const TurnHeader: React.FC<TurnHeaderProps> = ({
  ...
  return (
    <header className="rounded-2xl border border-slate-800 bg-slate-950/90 p-4 shadow-xl backdrop-blur-md flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4">
      ...
      {/* Action Buttons: Font Size, Sound, Home, Tutorial, Guide */}
      <div className="flex items-center gap-2 flex-wrap w-full xl:w-auto justify-end">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-cyan-300 text-xs font-mono font-bold transition-all"
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-cyan-950/40 hover:bg-cyan-900/60 border border-cyan-500/40 text-cyan-300 text-xs font-mono font-bold transition-all"
          title="開啟實戰引導新手教學"
        >
        ...
        <button
          onClick={onOpenGuide}
          className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-blue-950/40 hover:bg-blue-900/60 border border-blue-500/40 text-blue-300 text-xs font-mono font-semibold transition-all"
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-slate-200 text-xs font-mono font-bold transition-all"

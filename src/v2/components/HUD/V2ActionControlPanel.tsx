    ...
    <div className="rounded-3xl border border-slate-800 bg-slate-950/90 p-4 sm:p-5 shadow-2xl backdrop-blur-md font-mono flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <button
          ...
          className="p-3 rounded-2xl border text-xs flex items-center justify-center gap-2 transition-all active:scale-95 shadow-sm bg-slate-900 hover:bg-slate-800 border-slate-700 text-slate-200 font-bold"
        >

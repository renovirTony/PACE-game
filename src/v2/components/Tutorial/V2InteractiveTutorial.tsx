...
const tutorialSteps = [
  ...
  {
    step: 4,
    title: '第四步：戰術調換防線與倉庫存取',
    instruction: '調換防線需消耗 1 AP 戰術調度，請謹慎規劃！',
    detail: '點擊防線卡牌上的【🔄 調換 (1 AP)】，可消耗 1 AP 戰術調度點數與其他槽位對調；注意 [P] 主要防線限定最低需為 High 或 Medium 頻寬。點擊【📥 收存 (0 AP)】可將裝備安全卸下存入備用倉庫！',
  },
  {
    step: 5,
